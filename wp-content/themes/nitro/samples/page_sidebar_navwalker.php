	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 ) {
			...
			if ( $args->has_children && $depth === 0 ) {
				...
				$atts['class']			= 'list-group-item list-group-item-parent dropdown-toggle';
			 ...
			 */
			$item_output .= '<li'.$class_names.'><a'. $attributes .'><span class="bullet"></span>';
			$item_output .= '<div class="title">'.$args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after.'<span class="arrow"></span>';
			$item_output .= ( $args->has_children && 0 === $depth ) ? ' <span class="caret"></span></div></a>' : '</div></li></a>';
