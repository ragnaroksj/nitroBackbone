    ...
    <div id="wrap">       
        <nav class="navbar yamm navbar-default navbar-static-top" role="navigation" id="header"><!-- HEADER NAVSTART -->
          <div class="container">      
            ...
            <div class="page-banner"> <!-- SHOW PAGE BANNER -->     
                <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 pull-right hidden-xs">
                        <button class="btn btn-default pull-right contact-us"><a href="/contact_1/"><span class="icon icon-bubbles"></span>CONTACT</a></button>
                    </div>
                </div>
                </div>
            </div>
