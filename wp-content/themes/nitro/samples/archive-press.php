				...
				<div class="row archive-row-item">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<h3><time datetime="<?php echo the_time('F j, Y'); ?>" pubdate><?php the_time('F j, Y'); ?></time> - <a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
